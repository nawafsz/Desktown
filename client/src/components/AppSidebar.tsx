...
const navigationItems: NavItem[] = [
  ...
  { titleKey: "n8nService", url: "/n8n-settings", icon: Zap, categoryKey: "productivity", allowedRoles: ["member", "manager", "admin", "office_renter"] },
...
export function AppSidebar({ user }: AppSidebarProps) {
  ...
  const getItemLabel = (titleKey: string) => {
    const labels: Record<string, string> = {
      ...
      n8nService: language === 'ar' ? "خدمة n8n" : "n8n Service",
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="relative">
              <div className="w-12 h-12 rounded-xl bg-white shadow-sm flex items-center justify-center overflow-hidden border border-white/10">
