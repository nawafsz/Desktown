...
export const translations = {
  en: {
    ...
    landing: {
      welcomeTitle: "Welcome to OneDesk",
      ...
      readyToStartDesc: "Join thousands of businesses using OneDesk to establish their professional virtual presence.",
    ...
    n8n: {
      ...
      step4: "n8n sends the result back to OneDesk",
    ...
    advertising: {
      title: "Advertising",
      subtitle: "Promote your office or services to OneDesk visitors",
      ...
      subscriptionRequiredInfo: "Subscribe to OneDesk to unlock advertising features and promote your services to visitors.",
  ...
  ar: {
    ...
    landing: {
      welcomeTitle: "مرحباً بك في OneDesk",
      ...
      readyToStartDesc: "انضم إلى آلاف الشركات التي تستخدم OneDesk لإنشاء حضورها الافتراضي الاحترافي.",
    ...
    n8n: {
      ...
      step4: "يرسل n8n النتيجة إلى OneDesk",
    ...
    advertising: {
      title: "الإعلانات",
      subtitle: "روّج لمكتبك أو خدماتك لزوار OneDesk",
      ...
      subscriptionRequiredInfo: "اشترك في OneDesk لفتح ميزات الإعلان والترويج لخدماتك للزوار.",
