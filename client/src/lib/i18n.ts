...
export const translations = {
  en: {
    ...
    tickets: {
      ...
      newSupportRequestSubtitle: "Create a new support request",
      ...
      menuOverdue: "Overdue",
      menuFilter: "Filter",
      loginRequired: "Sign in to view assigned tickets",
      ...
      activeTicketsSubtitle: "Manage your active support requests",
  ...
  ar: {
    ...
    tickets: {
      ...
      totalSubtitle: "الكل الذي تم إنشاؤه",
      newSupportRequest: "طلب دعم جديد",
      newSupportRequestSubtitle: "إنشاء طلب دعم جديد",
      department: "القسم",
      ...
      menuOverdue: "متأخرة",
      menuFilter: "تصفية",
      loginRequired: "تسجيل الدخول لعرض التذاكر المسندة",
      ...
      openSubtitle: "مخصصة لك",
      resolvedSubtitle: "تم حلها بالكامل",
      activeTickets: "التذاكر النشطة",
      activeTicketsSubtitle: "إدارة طلبات الدعم النشطة",
