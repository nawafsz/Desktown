...
export const translations = {
  en: {
    ...
    tasks: {
      ...
      menuAllTasks: "All Tasks",
      menuNewTask: "New Task",
      menuMyTasks: "My Tasks",
      menuUnassigned: "Unassigned",
      menuAssignedToMe: "Assigned to Me",
      menuOverdue: "Overdue",
      menuFilter: "Filter",
      menuAutomation: "Automation",
      openSubtitle: "Assigned to you",
      completedSubtitle: "All completed",
      inProgressSubtitle: "All unresolved",
      totalSubtitle: "All generated",
    ...
    tickets: {
      ...
      loginRequired: "Sign in to view your tickets.",
      dashboardSection: "Dashboard",
      menuDashboard: "Dashboard",
      menuAllTickets: "All Tickets",
      menuNewTicket: "New Ticket",
      ...
      menuFilter: "Filter",
      openSubtitle: "Assigned to you",
      resolvedSubtitle: "All resolved",
      inProgressSubtitle: "All unresolved",
      totalSubtitle: "All generated",
      newSupportRequest: "New Support Request",
      newSupportRequestSubtitle: "Submit a new support ticket",
      department: "Department",
      selectDepartment: "Select Department",
      departmentSupport: "Support",
      departmentBilling: "Billing",
      departmentTechnical: "Technical Support",
      activeTickets: "Active Tickets",
      activeTicketsSubtitle: "Tickets currently in progress",
      unknown: "Unknown",
      supportCenter: "Support Center",
      navDashboard: "Dashboard",
      navAllTickets: "All Tickets",
      navNewTicket: "New Ticket",
      navSentiments: "Sentiments",
      navMyTickets: "My Tickets",
      navUnassigned: "Unassigned",
      navAssignedToMe: "Assigned to Me",
      navOverdue: "Overdue",
      ...
      supportCenterSubtitle: "Track and manage all support tickets",
      tabDashboard: "Dashboard",
      tabAllTickets: "All Tickets",
      tabNewTicket: "New Ticket",
      tabSentiments: "Sentiments",
      openTickets: "Open Tickets",
      openTicketsHelper: "Assigned to you",
      breaches: "Breaches",
      breachesHelper: "All overdue",
      inProgressHelper: "All unresolved",
      totalTickets: "Total Tickets",
      totalTicketsHelper: "All generated",
  ...
  ar: {
    ...
    tasks: {
      ...
      unassigned: "غير مكلف",
      noDate: "بدون تاريخ",
      loginRequired: "سجل الدخول لعرض مهامك.",
      dashboardSection: "لوحة التحكم",
      menuDashboard: "لوحة التحكم",
      menuAllTasks: "كل المهام",
      menuNewTask: "مهمة جديدة",
      menuMyTasks: "مهامي",
      menuUnassigned: "غير مكلفة",
      menuAssignedToMe: "مسندة إليّ",
      menuOverdue: "متأخرة",
      menuFilter: "تصفية",
      menuAutomation: "الأتمتة",
      openSubtitle: "مسندة إليك",
      completedSubtitle: "الكل مكتمل",
      inProgressSubtitle: "الكل قيد التنفيذ",
      totalSubtitle: "الإجمالي",
    ...
    tickets: {
      ...
      loginRequired: "سجل الدخول لعرض تذاكرك.",
      dashboardSection: "لوحة التحكم",
      menuDashboard: "لوحة التحكم",
      menuAllTickets: "كل التذاكر",
      menuNewTicket: "تذكرة جديدة",
      menuMyTickets: "تذاكري",
      menuUnassigned: "غير مخصصة",
      menuAssignedToMe: "مسندة إليّ",
      menuOverdue: "متأخرة",
      menuFilter: "تصفية",
      openSubtitle: "مسندة إليك",
      resolvedSubtitle: "الكل تم حله",
      inProgressSubtitle: "الكل غير محلول",
      totalSubtitle: "الإجمالي",
      newSupportRequest: "طلب دعم جديد",
      newSupportRequestSubtitle: "إرسال تذكرة دعم جديدة",
      department: "القسم",
      selectDepartment: "اختر القسم",
      departmentSupport: "الدعم",
      departmentBilling: "الفوترة",
      departmentTechnical: "الدعم الفني",
      activeTickets: "التذاكر النشطة",
      activeTicketsSubtitle: "التذاكر قيد التنفيذ حالياً",
      unknown: "غير معروف",
      supportCenter: "مركز الدعم",
      navDashboard: "لوحة التحكم",
      navAllTickets: "كل التذاكر",
      navNewTicket: "تذكرة جديدة",
      navSentiments: "المشاعر",
      navMyTickets: "تذاكري",
      navUnassigned: "غير مخصصة",
      navAssignedToMe: "مسندة إليّ",
      navOverdue: "متأخرة",
      ...
      supportCenterSubtitle: "تتبع وإدارة جميع تذاكر الدعم",
      tabDashboard: "لوحة التحكم",
      tabAllTickets: "كل التذاكر",
      tabNewTicket: "تذكرة جديدة",
      tabSentiments: "المشاعر",
      openTickets: "تذاكر مفتوحة",
      openTicketsHelper: "مسندة إليك",
      breaches: "مخالفات",
      breachesHelper: "الكل متأخر",
      inProgressHelper: "الكل غير محلول",
      totalTickets: "إجمالي التذاكر",
      totalTicketsHelper: "الإجمالي",
